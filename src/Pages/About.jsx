  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto p-10 bg-gray-700 bg-opacity-80 rounded-lg shadow-lg">
          <h1 className="text-6xl font-extrabold text-white mb-6 uppercase drop-shadow-lg">
            About Us
          </h1>
      ...
      <section className="bg-gray-700 text-white py-16 px-10 flex justify-center">
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-10">
          {/* Card 1: Company Overview */}
          <div className="bg-black p-8 rounded-lg shadow-lg border border-[#444444] text-center">
      ...
      <section className="bg-gray-700 text-white py-16 px-10 flex justify-center">
        <div className="max-w-5xl bg-green-100 p-10 rounded-lg shadow-lg border border-white w-full">
          <Testimonials />
        </div>
      </section>
