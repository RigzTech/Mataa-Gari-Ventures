...
const About = () => {
  return (
    <>
      ...
      {/* Company Overview */}
      <section className="bg-gray-800 text-white py-16 px-10 text-center">
        <h2 className="text-4xl font-bold text-[#99edc3] mb-8">Who We Are</h2>
      ...
      <section className="bg-black text-white py-16 px-10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col items-center text-center">
            <FaBullseye className="text-[rgb(153,237,195)] text-6xl mb-4" />
          ...
          {/* Vision */}
          <div className="flex flex-col items-center text-center">
            <FaEye className="text-[rgb(153,237,195)] text-6xl mb-4" />
      ...
      <section className="bg-gray-800 text-white py-16 px-10">
        <h2 className="text-4xl font-bold text-[#99edc3] text-center mb-8">Our Core Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center">
            <FaCheckCircle className="text-[rgb(153,237,195)] text-5xl mb-3" />
          ...
          <div className="flex flex-col items-center text-center">
            <FaUsers className="text-[rgb(153,237,195)] text-5xl mb-3" />
