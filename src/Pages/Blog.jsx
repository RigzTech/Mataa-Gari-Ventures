...
const Blog = () => {
  return (
    <>
      ...
      <section className="py-16 px-6 bg-gray-700 text-white flex justify-center">
        <div className="bg-gray-900 shadow-lg rounded-lg p-10 max-w-4xl text-center border border-[#99edc3]">
          <h1 className="text-5xl font-bold text-white uppercase">Auto Parts Blog</h1>
