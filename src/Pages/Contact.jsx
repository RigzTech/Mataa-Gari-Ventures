    ...
    <>
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-6xl font-extrabold text-white uppercase drop-shadow-lg">
            Contact Us
          </h1>
        </div>
      </section>
      ...
      <section className="bg-emerald-50 text-gray-700 py-16 px-10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          {/* Contact Info */}
          <div className="bg-green-100 bg-opacity-80 p-6 rounded-lg shadow-lg">
            ...
            <div className="flex space-x-4 mt-6">
              <a href="#" className="text-green-700 text-2xl hover:text-[#80d4aa]">
                <FaFacebook />
              </a>
              <a href="#" className="text-green-700 text-2xl hover:text-[#80d4aa]">
                <FaInstagram />
          ...
          {/* Contact Form */}
          <div className="bg-gray-200 bg-opacity-80 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-Black mb-4">Send Us a Message</h2>
            <form className="space-y-4">
              <input 
                type="text" 
                placeholder="Your Name" 
                className="w-full p-3 rounded bg-gray-300 bg-opacity-70 text-black focus:outline-none focus:ring-2 focus:ring-[#99edc3]"
              />
              <input 
                type="email" 
              ...
              <button 
                type="submit" 
                className="w-full bg-gray-900 text-white font-bold py-3 rounded hover:bg-[#80d4aa] transition"
              >
                Send Message
              </button>
            </form>
