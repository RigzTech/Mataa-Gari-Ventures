...
const ContactSection = () => {
  return (
<section className="flex justify-center items-center py-8 px-10 mt-0 bg-gray-900">
        ...
        <div className="mt-6">
          ...
          <Link to="/contact">
            <button className="bg-white text-black px-6 py-3 rounded-lg shadow-md transition-transform duration-200 hover:scale-110 hover:bg-yellow-500">
              Contact Now
            </button>
          </Link>
        </div>
