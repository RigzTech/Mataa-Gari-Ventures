    ...
    <nav className="bg-gray-700" style={{ boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)" }}>
      <div className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        <div className="hidden md:flex space-x-10 text-lg font-medium">
          ...
          <Link to="/about" className="text-white hover:text-emerald-400 transition">About</Link>
          <Link to="/products" className="text-white hover:text-emerald-400 transition">Products</Link>
          <Link to="/blog" className="text-white hover:text-emerald-400 transition">Blogs</Link>
