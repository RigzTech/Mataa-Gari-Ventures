...
const AboutUs = () => {
  return (
    <section className="flex justify-center items-center py-8 px-10 mb-0 bg-black">
      <div className="bg-gray-700 text-emerald-700 py-16 px-10 text-center rounded-lg shadow-lg transition-all duration-300 hover:shadow-2xl max-w-7xl w-full border-2 border-emerald-100">
        <h2 className="text-4xl font-bold text-white mb-8 font-serif">About Us</h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Card 1: We sell car spare parts */}
          <div className="bg-black p-6 rounded-lg shadow-md transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border-2 border-emerald-200 hover:border-emerald-300">
            <h3 className="text-2xl font-bold text-white mb-4">Car Spare Parts</h3>
