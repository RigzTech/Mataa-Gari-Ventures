    ...
    <>
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-6xl font-extrabold text-green-500 mb-6 uppercase drop-shadow-lg">
            About Us
          </h1>
      ...
      <section className="bg-gray-900 text-white py-16 px-10 text-center">
        <h2 className="text-4xl font-bold text-green-500 mb-8">Who We Are</h2>
      ...
      <section className="bg-black text-white py-16 px-10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col items-center text-center">
            <FaBullseye className="text-green-500 text-6xl mb-4" />
            <h3 className="text-3xl font-bold text-green-500 mb-3">Our Mission</h3>
          ...
          {/* Vision */}
          <div className="flex flex-col items-center text-center">
            <FaEye className="text-green-500 text-6xl mb-4" />
            <h3 className="text-3xl font-bold text-green-500 mb-3">Our Vision</h3>
            <p className="text-lg leading-relaxed">
      ...
      <section className="bg-gray-900 text-white py-16 px-10">
        <h2 className="text-4xl font-bold text-green-500 text-center mb-8">Our Core Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center">
            <FaUsers className="text-green-500 text-5xl mb-3" />
          ...
          <div className="flex flex-col items-center text-center">
            <FaTools className="text-green-500 text-5xl mb-3" />
            <h3 className="text-xl font-semibold">Expertise</h3>
            <p>We have years of experience in the auto parts industry.</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <FaHandshake className="text-green-500 text-5xl mb-3" />
      ...
      <section className="bg-black text-white py-16 px-10">
        <h2 className="text-4xl font-bold text-green-500 text-center mb-8"></h2>
        <Testimonials />
      </section>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <button
            className="mt-6 bg-green-500 text-black font-semibold px-6 py-3 rounded transition transform hover:scale-105 hover:bg-green-600"
